...
if (domainName === 'staging.thedapplist.com')
  defaultRestApi = 'https://staging.thedapplist.com/';
if (domainName === 'vote.thedapplist.com')
  defaultRestApi = 'https://vote.thedapplist.com';
